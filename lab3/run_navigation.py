...
ROOM_SWEEP_LEFT_ARC_DEGREES = 240
ROOM_SWEEP_RIGHT_ARC_DEGREES = 320
...
ROOM_SWEEP_LEFT_RETURN_SCALE = 0.7
ROOM_SWEEP_RIGHT_RETURN_SCALE = 1.2
ROOM_SWEEP_STEP_PAUSE_S = 0.8
ROOM_REALIGN_TO_HEADING = True
ROOM_HEADING_EXTRA_CORRECTION_DEG = 5.0
